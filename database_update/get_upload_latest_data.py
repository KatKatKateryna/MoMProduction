...
try:
    ...
    print("\nMoM GFMS")
    count = 0
    url   = BASE + "GFMS/GFMS_MoM/"
    files = list_server_files(url, r'href="(Attributes_Clean_\d{8}\.csv)"')
    for fname in files:
    ...
    print("\nMoM HWRF")
    count = 0
    url   = BASE + "HWRF/HWRF_MoM/"
    files = list_server_files(url, r'href="(Attributes_Clean_\d{10}HWRFUpdated\.csv)"')
    for fname in files:
    ...
    print("\nMoM DFO")
    count = 0
    url   = BASE + "DFO/DFO_MoM/"
    files = list_server_files(url, r'href="(Attributes_Clean_\d{10}MOM\+DFOUpdated\.csv)"')
    for fname in files:
    ...
    print("\nMoM VIIRS")
    count = 0
    url   = BASE + "VIIRS/VIIRS_MoM/"
    files = list_server_files(url, r'href="(Attributes_[Cc]lean_\d{10}MOM\+DFO\+VIIRSUpdated\.csv)"')
    for fname in files:
